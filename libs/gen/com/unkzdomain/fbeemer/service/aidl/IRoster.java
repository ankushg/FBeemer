 ...
 * Original file: /home/amgupt01/Desktop/beem/src/com/unkzdomain/fbeemer/service/aidl/IRoster.aidl
 */
package com.unkzdomain.fbeemer.service.aidl;
public interface IRoster extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.unkzdomain.fbeemer.service.aidl.IRoster
{
private static final java.lang.String DESCRIPTOR = "com.unkzdomain.fbeemer.service.aidl.IRoster";
...
/**
 * Cast an IBinder object into an com.unkzdomain.fbeemer.service.aidl.IRoster interface,
 * generating a proxy if needed.
 */
public static com.unkzdomain.fbeemer.service.aidl.IRoster asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.unkzdomain.fbeemer.service.aidl.IRoster))) {
return ((com.unkzdomain.fbeemer.service.aidl.IRoster)iin);
}
return new com.unkzdomain.fbeemer.service.aidl.IRoster.Stub.Proxy(obj);
}
...
com.unkzdomain.fbeemer.service.Contact _result = this.addContact(_arg0, _arg1, _arg2);
...
java.lang.String _arg0;
_arg0 = data.readString();
com.unkzdomain.fbeemer.service.Contact _result = this.getContact(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
java.util.List<com.unkzdomain.fbeemer.service.Contact> _result = this.getContactList();
reply.writeNoException();
...
java.lang.String _arg0;
_arg0 = data.readString();
com.unkzdomain.fbeemer.service.PresenceAdapter _result = this.getPresence(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
com.unkzdomain.fbeemer.service.aidl.IBeemRosterListener _arg0;
_arg0 = com.unkzdomain.fbeemer.service.aidl.IBeemRosterListener.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements com.unkzdomain.fbeemer.service.aidl.IRoster
{
...
public com.unkzdomain.fbeemer.service.Contact addContact(java.lang.String user, java.lang.String name, java.lang.String[] groups) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.unkzdomain.fbeemer.service.Contact _result;
try {
...
if ((0!=_reply.readInt())) {
_result = com.unkzdomain.fbeemer.service.Contact.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public void deleteContact(com.unkzdomain.fbeemer.service.Contact contact) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public com.unkzdomain.fbeemer.service.Contact getContact(java.lang.String jid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.unkzdomain.fbeemer.service.Contact _result;
...
public java.util.List<com.unkzdomain.fbeemer.service.Contact> getContactList() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
public com.unkzdomain.fbeemer.service.PresenceAdapter getPresence(java.lang.String jid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.unkzdomain.fbeemer.service.PresenceAdapter _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(jid);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.unkzdomain.fbeemer.service.PresenceAdapter.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public void addRosterListener(com.unkzdomain.fbeemer.service.aidl.IBeemRosterListener listen) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void removeRosterListener(com.unkzdomain.fbeemer.service.aidl.IBeemRosterListener listen) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {

 ...
 * Original file: /home/amgupt01/Desktop/beem/src/com/unkzdomain/fbeemer/service/aidl/IChat.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.unkzdomain.fbeemer.service.aidl.IChat
{
private static final java.lang.String DESCRIPTOR = "com.unkzdomain.fbeemer.service.aidl.IChat";
...
/**
 * Cast an IBinder object into an com.unkzdomain.fbeemer.service.aidl.IChat interface,
 * generating a proxy if needed.
 */
public static com.unkzdomain.fbeemer.service.aidl.IChat asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.unkzdomain.fbeemer.service.aidl.IChat))) {
return ((com.unkzdomain.fbeemer.service.aidl.IChat)iin);
}
return new com.unkzdomain.fbeemer.service.aidl.IChat.Stub.Proxy(obj);
}
...
com.unkzdomain.fbeemer.service.Message _arg0;
if ((0!=data.readInt())) {
_arg0 = com.unkzdomain.fbeemer.service.Message.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
com.unkzdomain.fbeemer.service.Contact _result = this.getParticipant();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
{
data.enforceInterface(DESCRIPTOR);
com.unkzdomain.fbeemer.service.aidl.IMessageListener _arg0;
_arg0 = com.unkzdomain.fbeemer.service.aidl.IMessageListener.Stub.asInterface(data.readStrongBinder());
...
{
data.enforceInterface(DESCRIPTOR);
java.util.List<com.unkzdomain.fbeemer.service.Message> _result = this.getMessages();
reply.writeNoException();
...
private static class Proxy implements com.unkzdomain.fbeemer.service.aidl.IChat
{
...
/**
    	 ...
    	 */
public void sendMessage(com.unkzdomain.fbeemer.service.Message message) throws android.os.RemoteException
{
...
/**
	 ...
	 */
public com.unkzdomain.fbeemer.service.Contact getParticipant() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
	 ...
	 */
public void addMessageListener(com.unkzdomain.fbeemer.service.aidl.IMessageListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	 ...
	 */
public void removeMessageListener(com.unkzdomain.fbeemer.service.aidl.IMessageListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public java.util.List<com.unkzdomain.fbeemer.service.Message> getMessages() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<com.unkzdomain.fbeemer.service.Message> _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getMessages, _data, _reply, 0);
_reply.readException();
_result = _reply.createTypedArrayList(com.unkzdomain.fbeemer.service.Message.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
